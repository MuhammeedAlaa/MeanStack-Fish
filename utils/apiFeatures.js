...
class APIFeatures {
  ...
  /**
   *  the function that handle filtering on the query string attached to the object
   *  this function retuen the same object put after filter the query string attached to this object
   */
  filter () {
    const queryObj = {
      ...this.queryString
  ...
  /**
   *  the function that handle sorting to the mongodb query attached to the object
   *  this function retuen the same object put after sorting the  mongodb query string attached to this objec
   */
  sort () {
  ...
  /**
   *  the function that handle filtering on the mongodb query fields results attached to the object
   *  this function retuen the same object put after filtering the  mongodb query string attached to this objec
   */
  ...
  /**
   * the function that handle pagination on the mongodb query results attached to the object
   *  this function retuen the same object put after pagination the  mongodb query string attached to this objec
   */
  ...
  /**
   * if is equivalent to paginate but works differently
   */
  offset () {
